...
<table width="50%" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td class="tdbline"><img src="images/77.png" alt="77vagetables" width="170" height="70"><p align="right"><a href="member_admin.php">回會員列表</a> | <a href="?logout=true">登出</a></p></td>
  </tr>
  <tr>
      ...
      <tr valign="top">
        <form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          <div class="dataDiv">
            ...
            <br><span class="smalltext">請確定此電子郵件為可使用狀態，以方便未來系統使用，如補寄會員密碼信。</span></p>
          ...
          <p align="center">
            ...
            <input type="button" name="Submit" value="取消修改" onClick="window.history.back();">
          </p>
        </form></td>
      </tr>
    </table></td>
